 ...
 */
public class CheckRequestVersion extends AbstractProfileAction<RequestAbstractType, StatusResponseType> {

    /** {@inheritDoc} */
    @Override
    protected void doExecute(
            @Nonnull final ProfileRequestContext<RequestAbstractType, StatusResponseType> profileRequestContext)
