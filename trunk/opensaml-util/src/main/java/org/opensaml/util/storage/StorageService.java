...
public interface StorageService extends InitializableComponent, DestructableComponent,
     ...
     * annotations in the org.opensaml.util.storage.annotation package. If any are missing, or
     ...
     * org.opensaml.util.storage.annotation package. If any are missing, or
     * a field inaccessible, a runtime exception of some kind will occur.</p>
     *
