 ...
 */
@ThreadSafe
public interface StorageServiceWithOptional extends InitializableComponent, DestructableComponent,
     ...
     * @param key           a key unique to context
     * 
     * @return  the record read back, if present
     * @throws IOException  if errors occur in the read process 
     */
    @Nonnull public Optional<StorageRecord> readString(@Nonnull @NotEmpty final String context,
    ...
    @Nonnull public Pair<Optional<Integer>, Optional<StorageRecord>> readString(@Nonnull @NotEmpty final String context,
            @Nonnull @NotEmpty final String key, @Nonnull final int version) throws IOException;
     ...
     * @throws IOException  if errors occur in the read process 
     */
    @Nonnull public Optional<StorageRecord> readText(@Nonnull @NotEmpty final String context,
            @Nonnull @NotEmpty final String key) throws IOException;
     ...
     * 
     * @return the version of the record after update, absent if no record exists
     ...
     */
    @Nonnull public Optional<Integer> updateStringWithVersion(final int version,
     ...
     * @param key           a key unique to context
     * 
     * @return the version of the record, absent if no record exists
     * @throws IOException  if errors occur in the update process 
     */
    @Nonnull public Optional<Integer> updateStringExpiration(@Nonnull @NotEmpty final String context,
            @Nonnull @NotEmpty final String key) throws IOException;
     ...
     * @throws VersionMismatchException if the record has already been updated to a newer version
     */
    @Nonnull public Optional<Integer> updateTextWithVersion(final int version,
            @Nonnull @NotEmpty final String context, @Nonnull @NotEmpty final String key,
            @Nonnull @NotEmpty final String value) throws IOException, VersionMismatchException;
     ...
     * @throws IOException  if errors occur in the update process 
     */
    @Nonnull public Optional<Integer> updateTextExpiration(@Nonnull @NotEmpty final String context,
            @Nonnull @NotEmpty final String key) throws IOException;
