...
public class TraversalException extends RuntimeException {
    ...
    /** Serial version UID. */
    private static final long serialVersionUID = 631570421737837907L;
     ...
     */
    public TraversalException(Exception wrappedException) {
     ...
     * @param wrappedException exception to be wrapped by this one
     */
    public TraversalException(String message, Exception wrappedException) {
