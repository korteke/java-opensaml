...
public class BreadthFirstTraverser implements Traverser {
     ...
     * @param isIncludeStartingNode whether the starting node is included in the traversed set of nodes
     */
    public BreadthFirstTraverser(@NotNull final Node start, boolean isIncludeStartingNode) {
        // TODO
    }
