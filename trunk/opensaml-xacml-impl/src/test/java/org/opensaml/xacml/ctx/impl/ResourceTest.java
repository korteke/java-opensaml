...
/**
 * Test case for creating, marshalling, and unmarshalling {@link org.opensaml.xacml.ctx.ResourceType}.
 */
public class ResourceTest extends XMLObjectProviderBaseTestCase {
     ...
     */
    public ResourceTest() {
        singleElementFile = "/org/opensaml/xacml/ctx/impl/Resource.xml";
        childElementsFile = "/org/opensaml/xacml/ctx/impl/ResourceChildElements.xml";
