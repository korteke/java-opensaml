 ...
 * @version $Revision$
 */
public class SecurityImpl extends AbstractExtensibleXMLObject implements
        Security {
     ...
     * {@inheritDoc}
     */
    public SecurityImpl(String namespaceURI, String elementLocalName,
     ...
     * (non-Javadoc)
     * 
     * @see org.opensaml.ws.wssecurity.Security#getMustUnderstand()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.opensaml.ws.wssecurity.Security#setMustUnderstand(boolean)
     */
    public void setMustUnderstand(boolean mustUnderstand) {
        // TODO: prepareForAssignment needed ???
        mustUnderstand_= mustUnderstand;
    }
