...
public interface ActorBearing {
    ...
    public static final String ACTOR_ATTR_LOCAL_NAME = "actor";

    /** The soap11:@actor qualified attribute name. */
    public static final QName ACTOR_ATTR_NAME =
        new QName(SOAPConstants.SOAP11_NS, ACTOR_ATTR_LOCAL_NAME, SOAPConstants.SOAP11_PREFIX);
     ...
     * 
     * @param newActor set the new list of attribute values
     */
