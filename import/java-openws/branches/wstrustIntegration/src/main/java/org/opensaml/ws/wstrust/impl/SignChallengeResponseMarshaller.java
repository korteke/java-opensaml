 ...
 * @version $Revision$
 */
public class SignChallengeResponseMarshaller extends
    ...
    public SignChallengeResponseMarshaller() {
        super(SignChallengeResponse.ELEMENT_NAME.getNamespaceURI(),
              SignChallengeResponse.ELEMENT_NAME.getLocalPart());
    }
