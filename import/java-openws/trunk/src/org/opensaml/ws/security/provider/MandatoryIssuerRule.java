...
/**
 * Security policy rule implementation that which requires that an inbound message context
 * issuer has been set by a previous rule.  Should typically run at the end of the security policy rule
 * chain.
 */
