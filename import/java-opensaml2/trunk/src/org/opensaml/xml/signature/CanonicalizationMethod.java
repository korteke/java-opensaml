...
/**
 * XMLObject representing XML Digital Signature, version 20020212, CanonicalizationMethod element.
 */
public interface CanonicalizationMethod extends XMLObject {

    /** Element local name */
    public final static String LOCAL_NAME = "CanonicalizationMethod";
