...
/**
 * Exception thrown when error occurs unmarshalling a DOM Element to a SAMLElement.
 */
public class UnmarshallingException extends SAMLException{
	
    /**
     * Serial version UID
     */
    private static final long serialVersionUID = 8542704762527553305L;
