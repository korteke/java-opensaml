...
/**
 * A thread safe {@link org.opensaml.common.io.Marshaller} for {@link org.opensaml.saml2.metadata.NameIDFormat} objects.
 */
public class NameIDFormatMarshaller extends AbstractSAMLObjectMarshaller {
    ...
    protected void marshallElementContent(SAMLObject samlObject, Element domElement) throws MarshallingException {
        ...
        if (format.getFormat() != null) {
            domElement.setTextContent(format.getFormat());
        }
    }
}