...
/**
 * A thread-safe {@link org.opensaml.common.io.Marshaller} for {@link org.opensaml.saml2.core.AuthnContextDeclRef}.
 */
public class AuthnContextDeclRefMarshaller extends AbstractSAMLObjectMarshaller {
    ...
    protected void marshallElementContent(SAMLObject samlObject, Element domElement) throws MarshallingException {
        ...
        domElement.setTextContent(authnContextDeclRef.getAuthnContextDeclRef());
    }
}