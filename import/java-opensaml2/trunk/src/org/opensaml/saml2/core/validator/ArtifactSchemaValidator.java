...
public class ArtifactSchemaValidator implements Validator {
    ...
    public void validate(XMLObject xmlObject) throws ValidationException {
        validateArtifact((Artifact) xmlObject);
    }
    
    /**
     * Test that Artifact element content is non-null and length > 0.
     * 
     * @param artifact
     * @throws ValidationException
     */
    protected void validateArtifact(Artifact artifact) throws ValidationException {
        if (artifact.getArtifact() == null || artifact.getArtifact().length() == 0)
