...
/**
 * Base for SAML 2.0 Assertion SAMLObjects that can be signed.
 */
public abstract class AbstractSignableAssertionSAMLObject extends AbstractSignableSAMLObject {

    /**
     * Constructor. Sets namespace to {@link SAMLConstants#SAML20_NS} and prefix to {@link SAMLConstants#SAML20_PREFIX}.
     * 
