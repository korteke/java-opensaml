...
/**
 * A thread-safe {@link org.opensaml.common.io.Marshaller} for {@link org.opensaml.saml2.core.AssertionURIRef}.
 */
public class AssertionURIRefMarshaller extends AbstractSAMLObjectMarshaller {
    ...
    protected void marshallAttributes(SAMLObject samlObject, Element domElement) throws MarshallingException {
        ...
        domElement.setTextContent(assertionURIRef.getURIRef());
    }
}