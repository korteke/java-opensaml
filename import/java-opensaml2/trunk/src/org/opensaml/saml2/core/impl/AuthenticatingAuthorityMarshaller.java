...
/**
 * A thread-safe {@link org.opensaml.common.io.Marshaller} for {@link org.opensaml.saml2.core.AuthenticatingAuthority}.
 */
public class AuthenticatingAuthorityMarshaller extends AbstractSAMLObjectMarshaller {
    ...
    protected void marshallElementContent(SAMLObject samlObject, Element domElement) throws MarshallingException {
        ...
        domElement.setTextContent(authenticatingAuthority.getURI());
    }
}