...
/**
 * A thread-safe {@link org.opensaml.common.io.Marshaller} for {@link org.opensaml.saml2.core.AuthnContextClassRef}.
 */
public class AuthnContextClassRefMarshaller extends AbstractSAMLObjectMarshaller {
    ...
    protected void marshallElementContent(SAMLObject samlObject, Element domElement) throws MarshallingException {
        ...
        domElement.setTextContent(authnContextClassRef.getAuthnContextClassRef());
    }
}