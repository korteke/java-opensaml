 ...
 */
public class EntityDescriptorSpecTest extends SAMLObjectValidatorBaseTestCase {

    /** Constructor */
    public EntityDescriptorSpecTest() {
        targetQName = new QName(SAMLConstants.SAML20MD_NS, EntityDescriptor.LOCAL_NAME,
