 ...
 */
public class AttributeProfileSchemaTest extends SAMLObjectValidatorBaseTestCase {

    /** Constructor */
    public AttributeProfileSchemaTest() {
        targetQName = new QName(SAMLConstants.SAML20MD_NS, AttributeProfile.LOCAL_NAME,
