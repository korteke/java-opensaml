...
public class ManageNameIDRequestTest extends RequestTest {
    ...
    public void testSingleElementMarshall() {
        QName qname = new QName(SAMLConstants.SAML20P_NS, ManageNameIDRequest.LOCAL_NAME);
        ManageNameIDRequest req = (ManageNameIDRequest) buildSAMLObject(qname);
