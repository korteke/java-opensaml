 ...
 */
public class SAMLProtocolMessageXMLSignatureSecurityPolicyRuleTest extends BaseSAMLSecurityPolicyTest {
    ...
    private SAMLProtocolMessageXMLSignatureSecurityPolicyRuleFactory signatureRuleFactory;
    ...
    protected void setUp() throws Exception {
        ...
        signatureRuleFactory = new SAMLProtocolMessageXMLSignatureSecurityPolicyRuleFactory();
        signatureRuleFactory.setTrustEngine(engine);
        
        issuerFactory = new StaticIssuerRuleFactory();
        issuerFactory.setIssuer(issuer);
        
        getPolicyRuleFactories().add(issuerFactory); 
        getPolicyRuleFactories().add(signatureRuleFactory);
    }
    ...
    public void testSuccess() {
        ...
        assertPolicySuccess("Protocol message was signed with trusted credential known to trust engine resolver");
        ...
        assertTrue("Unexpected value for context authentication state", 
                samlContext.isIssuerAuthenticated() == Boolean.TRUE);
    }
    ...
    public void testUntrustedCredential() {
        assertPolicyFail("Protocol message was signed with credential unknown to trust engine resolver");
    }
    ...
    public void testInvalidSignature() {
        ...
        assertPolicyFail("Protocol message signature was invalid due to document modification");
    }
    ...
    public void testNoContextIssuer() {
        issuerFactory.setIssuer(null);
        assertPolicyFail("Protocol message signature should have been unevaluable due to absence of context issuer");
    }
