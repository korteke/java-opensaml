...
public interface ProxyRestriction extends Condition {
    ...
    /** Element local name */
    public final static String DEFAULT_ELEMENT_LOCAL_NAME = "ProxyRestriction";
    ...
    public final static String TYPE_LOCAL_NAME = "ProxyRestrictionType"; 
    ...
    public final static String COUNT_ATTRIB_NAME = "Count";
