...
/**
 * Interface for xacml:policy PolicySetIdReferance
 * 
 */
public interface XACMLPolicySetIdReference extends SAMLObject {
	
    /** Element local name. */
    public static final String DEFAULT_ELEMENT_LOCAL_NAME = "PolicySetIdReferance";
    ...
    public static final String TYPE_LOCAL_NAME = "XACMLPolicySetIdReferanceType";
