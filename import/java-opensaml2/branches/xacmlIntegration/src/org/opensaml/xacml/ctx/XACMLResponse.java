...
/**
 * Interface for xacml-context Response
 * 
 *
 */public interface XACMLResponse extends SAMLObject{
    ...
    /**
     * Setss the result of the response
     * @param newResult result of the response
     */
    public void setResult(XACMLResult newResult);
