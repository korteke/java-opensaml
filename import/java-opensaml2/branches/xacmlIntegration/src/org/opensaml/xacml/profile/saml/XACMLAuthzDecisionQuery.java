...
/**
 *
 * A xacml-saml:XACMLAuthzDecisionQuery
 *
 */

public interface XACMLAuthzDecisionQuery extends RequestAbstractType {
     ...
     * 
     * @return boolean if the {@link org.opensaml.xacml.ctx.XACMLRequest} should be included in the response 
     */
     ...
     * Sets if external attributes is allowed in the decision, true if it's allowed.
     * 
     * @param inputContextOnly false if external attributes is allowed in the decision, true if it's allowed.
     */
    	
	public void setInputContextOnlyXSBooleanValue(XSBooleanValue inputContextOnly);
	
	/**
	 * Set's if the {@link org.opensaml.xacml.ctx.XACMLRequest} should be included inside the request message
	 * 
	 * @param returnContext is true if the {@link org.opensaml.xacml.ctx.XACMLRequest} should be included inside the request message
	 */
	...
	public void setReturnContextXSBooleanValue(XSBooleanValue returnContext);	
	
	
	/**
	 * Sets if the PDP can combine policies from this query and the one locally
	 * @param combinePolicies Sets if the PDP can combine policies from this query and the one locally
	 */
