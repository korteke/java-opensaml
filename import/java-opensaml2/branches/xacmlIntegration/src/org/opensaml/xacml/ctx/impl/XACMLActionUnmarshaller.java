...
public class XACMLActionUnmarshaller extends AbstractSAMLObjectUnmarshaller {

	/**
     * Constructor
     */
    public XACMLActionUnmarshaller() {
        super();
    }
     ...
     */
    protected XACMLActionUnmarshaller(String namespaceURI, String elementLocalName) {
