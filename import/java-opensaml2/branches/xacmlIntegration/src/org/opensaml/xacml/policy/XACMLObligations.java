...
/**
 *Interface for xacml:policy Obligations 
 *
 */
public interface XACMLObligations extends SAMLObject {

	/** Local name of the element. */
    public static final String DEFAULT_ELEMENT_LOCAL_NAME = "Obligations";

    /** Default element name for XACML20. */
    ...
    public static final String TYPE_LOCAL_NAME = "ObligationsType";
     ...
     * @return the obligations of the element
     */
