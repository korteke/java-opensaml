...
public class XACMLResultUnmarshaller extends AbstractSAMLObjectUnmarshaller {

	/**
     * Constructor
     */
    public XACMLResultUnmarshaller() {
        super();
    }
     ...
     */
    protected XACMLResultUnmarshaller(String namespaceURI, String elementLocalName) {
