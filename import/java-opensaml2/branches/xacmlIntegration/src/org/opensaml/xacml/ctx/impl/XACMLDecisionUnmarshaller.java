...
public class XACMLDecisionUnmarshaller extends AbstractSAMLObjectUnmarshaller {

	 /** Constructor */
    public XACMLDecisionUnmarshaller() {
        super();
    }
     ...
     */
    protected XACMLDecisionUnmarshaller(String namespaceURI, String elementLocalName) {
