 ...
 */
public interface AuthzDecisionQueryDescriptor extends QueryDescriptorType {
    
    /** Element local name */
    public final static String DEFAULT_ELEMENT_LOCAL_NAME = "AuthzDecisionQueryDescriptor";
    ...
    public final static String TYPE_LOCAL_NAME = "AuthzDecisionQueryDescriptorType";
