...
/**
 * Abstract implementation of {@link TrustEngine}.
 * 
 * @param <TokenType> the token type this trust engine evaluates
 */
public abstract class AbstractTrustEngine<TokenType> implements TrustEngine<TokenType> {
    ...
    /**
     * Set the resolver used to resolve trusted credentials.
     * 
