...
public interface CredentialResolver<ContextType extends CredentialContext> {
    ...
    /**
     * Get the credential context class to be generated by this resolver.
     * 
     * @return the class of the credential context
     */
    public Class<? extends ContextType> getContextClass();
    
    /**
     * Set the credential context class to be generated by this resolver.
     * 
     * @param contextClass the credential context class
     */
    public void setContextClass(Class<? extends ContextType> contextClass);
