...
/**
 * An interface for credentials derived from a KeyInfo element which provides
 * access to the underlying {@link KeyInfo} context.
 */
public interface KeyInfoCredential extends Credential {
