...
public interface AgreementMethod extends ValidatingXMLObject, ElementExtensibleXMLObject {
    ...
    /** Element local name */
    public final static String DEFAULT_ELEMENT_LOCAL_NAME = "AgreementMethod";
    ...
    public final static String TYPE_LOCAL_NAME = "AgreementMethodType"; 
        
    /** QName of the XSI type */
    public final static QName TYPE_NAME = new QName(XMLConstants.XMLENC_NS, TYPE_LOCAL_NAME, XMLConstants.XMLENC_PREFIX);
    
    /** Algorithm attribute name*/
    public final static String ALGORITHM_ATTRIBUTE_NAME = "Algorithm";
