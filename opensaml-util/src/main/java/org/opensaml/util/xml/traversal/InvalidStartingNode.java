...
public class InvalidStartingNode extends TraversalException {
     ...
     */
    public InvalidStartingNode(String message) {
        super(message);
    }
     ...
     */
    public InvalidStartingNode(Exception wrappedException) {
     ...
     * @param wrappedException exception to be wrapped by this one
     */
    public InvalidStartingNode(String message, Exception wrappedException) {
