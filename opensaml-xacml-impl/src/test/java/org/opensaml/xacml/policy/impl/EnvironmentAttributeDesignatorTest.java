 ...
 * {@link org.opensaml.xacml.policy.AttributeDesignatorType} subtype Environment.
 */
public class EnvironmentAttributeDesignatorTest extends XMLObjectProviderBaseTestCase {
    ...
    public EnvironmentAttributeDesignatorTest(){
        ...
        optionalIssuer = "TheIssuerEnvironment";
    ...
    public void testSingleElementMarshall(){
        AttributeDesignatorType attributeDesignator = (AttributeDesignatorType) buildXMLObject(AttributeDesignatorType.ENVIRONMENT_ATTRIBUTE_DESIGNATOR_ELEMENT_NAME);
