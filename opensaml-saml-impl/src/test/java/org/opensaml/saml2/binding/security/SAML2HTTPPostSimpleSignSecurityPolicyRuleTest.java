...
import org.opensaml.saml.saml2.binding.security.SAML2HTTPPostSimpleSignRule;
 ...
 */
public class SAML2HTTPPostSimpleSignSecurityPolicyRuleTest extends
        BaseSAMLSecurityPolicyRuleTestCase<AuthnRequest, Response, NameID> {
    ...
    protected AuthnRequest buildInboundSAMLMessage() {
        AuthnRequest request = (AuthnRequest) unmarshallElement("/data/org/opensaml/saml2/binding/AuthnRequest.xml");
